      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Adarsh Nema </span>
            from <span className="purple"> Agra, India.</span>
            <br /> I am a prer final year student pursuing BTech 
             Computer Science at Vellore Institute of Technology Bhopal.
            <br />
